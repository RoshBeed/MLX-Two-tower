...
with open('text8') as f: text8: str = f.read()  # Use all data
...
first_id = tokens[0]
print(ids_to_words[first_id])        # should print the first word
print(words_to_ids[ids_to_words[first_id]])  # should print the same id
